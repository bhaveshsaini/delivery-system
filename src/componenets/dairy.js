            ...
            <div>
                ...
                <nav className="w3-sidebar w3-bar-block w3-white w3-collapse w3-top" id="mySidebar">
                    ...
                    <div id={'firstdiv'} className="w3-padding-64 w3-large w3-text-grey">
                        ...
                        <a id={'dairy'} onClick={() => this.props.history.push('/dairy')} className="w3-bar-item w3-button">Dairy</a>
                    </div>
                ...
                <div className="w3-main">
                    ...
                    <div className={'searchbar'}>
                        <input onChange={this.searchbar} type="text" placeholder="Search for dairy items" name="search"/>
                    </div>
